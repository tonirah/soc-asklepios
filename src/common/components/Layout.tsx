...
export function Layout({ children }: { children: ReactNode }) {
  ...
  const { getProgressPercentage, resetProgress } = useContext(ProgressContext);
  ...
  return (
    <>
      ...
      >
        <div className="container mx-auto text-center pt-10 pb-32 px-2">
          {children}
        </div>
        <div className="w-full text-center bg-base-300 border-t border-neutral h-32">
          <div className="container mx-auto text-center pt-10 px-2 flex justify-center">
            ...
            <button
              className="btn btn-xs btn-warning py-1.5 px-3 w-fit h-fit text-left leading-tight mx-2"
