...
export default function Info() {
  ...
  return (
    <>
      ...
      <div className="bg-neutral/70 border border-neutral shadow-xl mx-auto py-12 max-w-3xl rounded-box">
        <div className="prose lg:prose-lg mx-auto px-5">
          ...
          <p className="lead">
            ...
            Schiffes 'SOC Asklepios' hat dich geweckt. Du musst ihr helfen, die
            Boardsoftware zu prüfen und zu refaktorisieren, um sicher auf dem
            Planet 'Yagni' landen zu können.“
          </p>
          ...
          <p>
            ...
            {MIN_CHARACTERS_FOR_COMBOBOX} Buchstaben eingegeben hast werden dir
            mögliche Eingaben vorgeschlagen (Combobox mit Autosuggest).
          </p>
          <h3 className="text-secondary underline decoration-accent">
            Details
          </h3>
          ...
          <p>
            ...
            einschätzen. Sie kann nicht sicher feststellen ob Refactorings nötig
            sind, und sie kann diese auch nicht durchführen. Daher hat sie die
            einzelnen Systeme auf ein Minimum heruntergefahren.
          </p>
