  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'cfs-hover': `url('${basePath}/images/ship/cfs-hover.png')`,
        'vtc-off': `url('${basePath}/images/ship/vtc-off.png')`,
        'vtc-hover': `url('${basePath}/images/ship/vtc-hover.png')`,
        'chh-off': `url('${basePath}/images/ship/chh-off.png')`,
        'chh-hover': `url('${basePath}/images/ship/chh-hover.png')`,
        'srp-off': `url('${basePath}/images/ship/srp-off.png')`,
        'srp-hover': `url('${basePath}/images/ship/srp-hover.png')`,
